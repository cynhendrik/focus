  ...
  return (
    <div style={{ minWidth: 300, maxWidth: 380, position: 'relative' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div key={todo.id} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <button
              ...
              style={{
                ...
                border: '1px solid rgba(59,109,244,0.4)',
                background: 'transparent', flexShrink: 0, cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                transition: 'all 150ms',
              }}
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(59,109,244,0.15)' }}
        ...
        {todayTodos.length === 0 && (
          <span style={{ fontSize: 13, color: 'rgba(59,109,244,0.4)' }}>Alle Aufgaben erledigt ✓</span>
        )}
      </div>

      <div style={{ width: 40, height: 1, background: 'rgba(59,109,244,0.15)', margin: '16px 0 10px' }} />
      <div style={{ fontSize: 10, color: 'rgba(59,109,244,0.35)' }}>Direkt abhaken</div>
