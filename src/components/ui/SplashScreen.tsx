...
// Timing (ms)
const PHASE_NOISE    = 1400   // pure numeric noise
const PHASE_EXPAND   = 600    // pool expands to alphnum
const PHASE_DECODE   = 3000   // left-to-right char lock-in
        ...
        {chars.map((char, i) => (
          <span
            ...
            style={{
              ...
              transition:        i < resolved ? 'color 120ms ease' : 'none',
